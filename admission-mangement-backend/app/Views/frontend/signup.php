...
<div class="container mt-5">
    <div class="row justify-content-md-center">
        ...
        <div class="col-md-6" style="padding-top:150px">
            ...
            <?php endif; ?>
            <form action="<?php echo base_url("user/frontend/store"); ?>" method="post">
            ...
            <br>
            <div class="text-center"><a class="text-decoration-none" href="<?php echo base_url("user/frontend/signin"); ?>">Already a User? need signin</a></div>
        </div>
    </div>
</div>
