...
class CircularSeeder extends Seeder
{
    public function run()
    {
        $data = [
            ...
            'circular_details'    => 'Muslim modern has primary also secondary education facilities. Playground, Labs, and Library are all facilities gathered will need for a good education environment. Admit your child here to give him or her a better education.
